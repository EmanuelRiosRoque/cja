...
@php
  ...
  $base = 'relative group w-full flex items-center gap-3 px-3 py-2 rounded-lg text-[15px] text-gray-700
           ...
           before:absolute before:inset-y-1 before:left-0 before:w-1 before:rounded-full before:bg-emerald-500
           before:opacity-0 before:transition';

  $activeClasses = $isActive
      ? ' bg-emerald-50 text-emerald-700 border-emerald-200 before:opacity-100'
      : '';
@endphp
